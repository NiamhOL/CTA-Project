...
# Section 5 - User Interface  adapted from https://github.com/shkyler/gmit-cta-project/blob/master/project.py
...
def main():
  ...
  allowed_modes = ["graph", "table"]
  mode_chosen = input("How would you like to view the benchmark test? - graph/table   ")
